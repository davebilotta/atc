...
var debug = true; // True if in debug mode
...
var SHIP1_SPEED = 20; // How fast will a Ship (Class 1) be?
var SHIP2_SPEED = 30; // How fast will a Ship (Class 2) be?
var UFO_SPEED = 20; // How fast will a UFO be?
var OBSTACLE_MAX_SPEED = 25; // Max speed of obstacles
var SPAWN_DELAY = 3.5; // How long between new ships/obstacles?
...
var dragEnabled, dragStart, dragEnd;
...
Game.prototype = {
    ...
    render: function() {
        ...
        //if (id != -1)  highlightSelectedShip(id);
